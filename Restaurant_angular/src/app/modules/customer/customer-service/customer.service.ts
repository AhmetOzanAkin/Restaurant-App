...
export class CustomerService {
  ...
  getProductsByCategory(categoryId: number): Observable<any> {
    return this.http.get<any>(BASIC_URL + `/api/customer/${categoryId}/products`, {
      headers: this.createAuthorizationHeader()
    })
  }
  ...
  getProductsByCategoryAndTitle(categoryId: number ,title: string): Observable<any> {
    ...
    return this.http.get<any>(BASIC_URL + `/api/customer/${categoryId}/product/${title}`, {
      headers: this.createAuthorizationHeader()
    });
  }
  ...
  postReservation(reservationDto: any): Observable<any> {
    ...
    return this.http.post<any>(BASIC_URL + `/api/customer/reservation`, reservationDto, {
      headers: this.createAuthorizationHeader()
    });
  }

  getReservationsByUser(): Observable<any> {
    return this.http.get<any>(BASIC_URL + `/api/customer/reservations/${StorageService.getUserId()}`, {
      headers: this.createAuthorizationHeader()
    })
  }
